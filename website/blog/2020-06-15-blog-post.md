...
*_Figure 1: Number of property sales by neighborhood_*
...
*_Figure 2: Median sales price change per neighborhood_*
...
*_Figure 3: Percent change in sale price to income ratio_*
...
*_Figure 4: Change in price-to-income ratio_*
...
*_Figure 5: Features Importance of the Final Random Forest Regressor_*
...
*_Table 1: Neighborhoods with highest predicted price-to-income ratio_*
...
*_Figure 6: Sales price-to-income ratio and number of affordable housing units_*
...
## Appendix
*_Appendix I: Random Forest Regressor Hyper Parameters Tuning Checks_*
